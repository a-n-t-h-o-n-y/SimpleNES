...
int main(int argc, char** argv)
{
    ...
    // Default keybindings
    // std::vector<sf::Keyboard::Key> p1{
    //     sf::Keyboard::J,      sf::Keyboard::K, sf::Keyboard::RShift,
    ...
    //         else
    //             LOG(sn::Error)
    //                 << "Setting scale from argument failed" << std::endl;
    //         ++i;
    //     }
    ...
    //         else
    //             LOG(sn::Error)
    //                 << "Setting width from argument failed" << std::endl;
    //         ++i;
    //     }
    ...
    //         else
    //             LOG(sn::Error)
    //                 << "Setting height from argument failed" << std::endl;
    //         ++i;
    //     }
    //     else if (argv[i][0] != '-')
    //         path = argv[i];
